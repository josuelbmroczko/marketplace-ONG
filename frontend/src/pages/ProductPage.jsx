...
  const { user } = useAuth();
  console.log("VERIFICANDO ROLE DO USUÁRIO:", user); // Você pode manter isso para depurar
...
  // --- Estados da Lógica de Busca e Carrinho ---
...
                    {/* Coluna da ONG (para Usuário ou Visitante) */}
...
                    {/* Coluna de Ações (para Admin ou Gerente) */}
                    {user && (user.role === 'ROLE_ADMIN' || user.role === 'ROLE_GERENTE') ? (
                      <td>
...
                    {/* Coluna de Comprar (para Usuário) */}
                    {user && user.role === 'ROLE_USUARIO' ? (
                      <td>
